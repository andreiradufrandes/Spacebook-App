...
//      ADD error handling here
      updateDetails = async () =>{
        ...
        if ((this.state.first_name != this.state.origin_first_name) && (this.state.first_name != '')){
          to_send['first_name'] = this.state.first_name;
        }
        // if (this.state.last_name != this.state.origin_last_name){
        if ((this.state.last_name != this.state.origin_last_name) && (this.state.last_name != '')){
        ...
        //   ADD ALERT HERE 
            ...
            Alert.alert('Update', "User details have been updated correctly",[
                {
                    text:'Ok',onPress:() => console.log("alert has been closed")
                }
            ])
