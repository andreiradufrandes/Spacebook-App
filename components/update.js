...
TODO:
    - Update the origin details in the state 
        - add a get data function that gets it 
        - get the details from there and set them to that
    - Do this WHEN THE PAGE IS LOADED
    - then, on click, update the details
